...
;  BEGIN student code
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
mov rax, rsi ;put rsi into rax (stosb needs rax)
mov rcx, rdx ;loop rdx # of times (rep needs rcx)
rep stosb ;put rax/rsi into rdi
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;  END student code
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    pop rbp
...
;  BEGIN student code
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
mov rcx, rdx ;put rdx into rcx (rep needs rcx)
rep movsb ;put rsi into rdi
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;  END student code
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    pop rbp
...
;  BEGIN student code
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
xor rax, rax ;zeroize rax for repne
mov rcx, 0xffffffff ;set max string size
mov rdx, rcx ;copy rcx into rdx
repne scasb ;repeat until you find a null term (rax), decrement rcx
sub rdx, rcx ;get difference of rcx and rdx (how many times you looped before finding null term)
sub rdx, 1 ;remove null term from string length
mov rax, rdx ;copy string length into rax
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;  END student code
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    pop rbp
